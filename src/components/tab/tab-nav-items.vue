<template>
  <li :class="liClass" @click="clicked">
    <a :class="'nav-link '+className+' '+widthclass" :id="id" :data-toggle="dataToggle" :href="url" :role="role" :aria-controls="ariaControls" :aria-selected="ariaSelected" :data-extras="dataextras">
...
export default {
  ...
  props: {
    ...
    dataextras:{type:String, default:''}
  },
  mounted () {
    if (this.active) {
