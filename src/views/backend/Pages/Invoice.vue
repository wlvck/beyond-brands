<template>
    <div class="container">
         <b-row>                  
            <b-col lg="12" >
               <card class=" card-block card-stretch card-height print rounded" headerClass="bg-primary header-invoice">
                   <template v-slot:headerTitle>
                           <h4 class="card-title mb-0">Invoice#1234567</h4>
                   </template>
                   <template v-slot:headerAction>
                        <div class="invoice-btn">
                           <button type="button" class="btn btn-primary-dark active mr-3"><i class="las la-print"></i> Print
                              Print</button>
                           <button type="button" class="btn btn-primary-dark active"><i class="las la-file-download"></i>PDF</button>
                        </div>
                  </template>
