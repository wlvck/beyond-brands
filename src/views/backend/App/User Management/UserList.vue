                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a class="iq-bg-primary" v-b-tooltip.top title="Add" href="#"><i class="ri-user-add-line mr-1"></i></a>
                                          <a class="iq-bg-primary" v-b-tooltip.top title="Edit"  href="#"><i class="ri-pencil-line mr-1"></i></a>
                                          <a class="iq-bg-primary"  v-b-tooltip.top title="Delete"  href="#"><i class="ri-delete-bin-line mr-1"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <tr>
